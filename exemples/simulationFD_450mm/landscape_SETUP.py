...
grass_proportion = 0.80 #Proportion of the veg distribution that is grass (must sum to 1 with shrub and tree)
shrub_proportion = 0.10 #Proportion of the veg distribution that is shrub (must sum to 1 with grass and tree)
tree_proportion = 0.10 #Proportion of the veg distribution that is tree (must sum to 1 with grass and shrub)
...
wind_time = np.arange(0, wind_iterations)*(wind_event_frequency/veg_update_frequency*veg_update_freq_equivalent/12) #Equivalance of wind iterations in years
...
veg_time = np.arange(0, veg_iterations)*(veg_update_freq_equivalent/12) #Equivalance of veg iterations in years
...
grazing_time = np.arange(0, grazing_iterations)*(GrAM_frequency/veg_update_frequency*veg_update_freq_equivalent/12) #Equivalance of grazing iterations on years
