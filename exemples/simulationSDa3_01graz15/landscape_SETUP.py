...
last_dir = '/home/phillgb/projects/def-kingj/phillgb/simulation1161_finalGrazing/' #Specify the directory where output files can be found to manually specify starting state of the next simulation
...
stocking_rate = 0.01 #For grazing - number of livestock per hectare (typically up to ~0.06; above 0.06 counts as severely degraded)
