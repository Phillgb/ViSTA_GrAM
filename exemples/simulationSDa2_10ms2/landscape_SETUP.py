...
last_dir = '/home/phillgb/projects/def-kingj/phillgb/simulation1022_finalSed/' #Specify the directory where output files can be found to manually specify starting state of the next simulation
...
wind_event_constant = 10 #For 'constant' (m/s) <--- Unobstructed windspeed entering grid for that timestep
