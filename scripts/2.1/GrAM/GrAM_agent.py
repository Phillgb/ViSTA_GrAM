...
class Grazers(Agent):
    ...
    def eat(self):
        ...
        self.model.veg_height_grid = wrap_grid(self.model.veg_height_grid, 0) # Wrap vegetation height grid for eating process
        self.model.veg_type_grid = wrap_grid(self.model.veg_type_grid, 0) # Wrap vegetation type grid for eating process
        
        # Eating loop of a 2x2 cell area around the position of the grazer
        for dy in range(-2, 3):
            for dx in range(-2, 3):
                if self.model.veg_height_grid[wy+dy, wx+dx] > veg_threshold and self.model.veg_type_grid[wy+dy, wx+dx] == 1:
        ...
        self.model.veg_height_grid = unwrap_grid_2(self.model.veg_height_grid, 0)
        self.model.veg_type_grid = unwrap_grid_2(self.model.veg_type_grid, 0)
